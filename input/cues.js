/**
 * Return the cues that will be used in the association task.
 * Each cue will be presented once; the participant will be asked to respond with up to three associations.
 */
function getCues() {
